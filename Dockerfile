...
COPY --from=build /root/src/main/resources/themes/messages/ /opt/jboss/keycloak/themes/messages
COPY --from=build /root/src/main/resources/themes/templates/ /opt/jboss/keycloak/themes/templates
